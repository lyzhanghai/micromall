...
CREATE TABLE `order` (
  ...
  `realpay_amount` decimal(10,2) NOT NULL COMMENT '实付金额',
  `balancepay_amount` decimal(10,2) NOT NULL COMMENT '余额支付金额',
  ...
  `shipping_address` varchar(150) NOT NULL COMMENT '收货地址信息',
...
CREATE TABLE `shipping_address` (
  ...
  `detailed_address` varchar(150) NOT NULL COMMENT '详细地址',
  `consignee_name` varchar(30) NOT NULL COMMENT '收货人姓名',
  `consignee_phone` varchar(15) NOT NULL COMMENT '收货人电话',
  `postcode` char(6) DEFAULT NULL COMMENT '邮政编码',
